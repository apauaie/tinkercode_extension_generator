...
Blockly.Msg.CAT_TUAH = "Tuah";
Blockly.Msg.CAT_TUAH_MINI = "Tuah Bot";
Blockly.Msg.CAT_MICROBOT_MINI = "MicroBot Mini";
Blockly.Msg.CAT_JEBAT = "Jebat Bot";
Blockly.Msg.CAT_EUREQA = "euREQA";
Blockly.Msg.CAT_MKIT = "MakerKit";
Blockly.Msg.CAT_MAKERKIT = "MakerKit Nano";
Blockly.Msg.CAT_MAKERKIT_WIFI = "MakerKit Wifi";
Blockly.Msg.CAT_MAKERKIT_INNOV = "MakerKit Innov";
Blockly.Msg.CAT_MAGNOV = "Magnov";
Blockly.Msg.CAT_MECHABOT_RUSH = "Mechabot Rush";
Blockly.Msg.CAT_MECHABOT = "Mechabot Rush";
Blockly.Msg.CAT_MECHABOTV2 = "Mechabot Rush 2 (Beta)";
Blockly.Msg.CAT_MECHABOTV3 = "Mechabot Rush 3 (Hikari)";
Blockly.Msg.CAT_MECHABOTV4 = "Mechabot Rush New";
Blockly.Msg.CAT_SUMO_KIT = "Sumo Kit";
Blockly.Msg.CAT_SUMO_ADV = "Sumo Advance";
Blockly.Msg.CAT_HIKARI = "Hikari";
Blockly.Msg.CAT_MATRIXRGB="Matrix RGB";
Blockly.Msg.CAT_KIT = "Base Controller";
Blockly.Msg.CAT_BOT = "Robot Kit";
Blockly.Msg.CAT_MOTIVE = "Motive";
Blockly.Msg.CAT_ESP8266 = "IoT";
Blockly.Msg.CAT_NODEMCU = "ESP8266 NodeMCU";
Blockly.Msg.CAT_MICROBIT = "BBC Microbit";
Blockly.Msg.CAT_MHET = "ESP32 MiniKit";
...
Blockly.Msg.CAT_nodemcu_IN = "In";
Blockly.Msg.CAT_nodemcu_OUT = "Out";
Blockly.Msg.CAT_nodemcu_CONVERSION = "converting";
Blockly.Msg.CAT_nodemcu_TIME = "time";
Blockly.Msg.CAT_nodemcu_COMM_SERIAL = "serial communication";
Blockly.Msg.CAT_nodemcu_COMM_SOFTSERIAL = "softserial lib";
Blockly.Msg.CAT_nodemcu_SERVO = "Servo-Motor";
Blockly.Msg.CAT_JEBAT = "Jebat"; //added february 12th 2020

Blockly.Msg.CAT_MQTT = "MQTT"; //added february 12th 2020
...
Blockly.Msg.ARDUINO_BASE_DELAY_DELAY_TIME_SEC = "wait (in seconds)";
...
Blockly.Msg.ARDUINO_BASE_MAP_NUM ="Map ";
Blockly.Msg.ARDUINO_BASE_MAP_DMAX = "value to [0-";
...
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT1 = "DigitalWrite PIN#";
Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT2 = "Stat";
...
Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_INPUT = "DigitalRead PIN#";
...
Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_INPUT1 = "AnalogWrite PIN#";
...
Blockly.Msg.ARDUINO_SERIAL_PRINT_CONTENT = "Serial Print";
...
Blockly.Msg.nodemcu_BASE_DELAY_HELPURL = "http://nodemcu.cc/en/Reference/delay";
Blockly.Msg.nodemcu_BASE_DELAY_DELAY_TIME = "delay (in ms)";
Blockly.Msg.nodemcu_BASE_DELAY_DELAY_TIME_SEC = "wait (in seconds)";
Blockly.Msg.nodemcu_BASE_DELAY_TOOLTIP = "specify the pause time in milliseconds";
Blockly.Msg.nodemcu_BASE_SETUP = "Setup";
Blockly.Msg.nodemcu_BASE_SETUP_HELPURL = "https://www.nodemcu.cc/en/Reference/Setup";
Blockly.Msg.nodemcu_BASE_LOOP = "nodemcu loop forever:";
Blockly.Msg.nodemcu_BASE_SETUP_LOOP_HELPURL = "https://www.nodemcu.cc/en/Reference/Loop";
Blockly.Msg.nodemcu_SINCE_PROGRAM_STARTED_HELPURL = "https://www.nodemcu.cc/en/Reference/Millis";
Blockly.Msg.nodemcu_SINCE_PROGRAM_STARTED = "time (in ms) since program started";
Blockly.Msg.nodemcu_SINCE_PROGRAM_STARTED_SEC = "time (in s) since program started";
Blockly.Msg.nodemcu_SINCE_PROGRAM_STARTED_TOOLTIP = "Number of milliseconds since the program started (unsigned long)";
Blockly.Msg.nodemcu_BETWEEN = "random number between";
Blockly.Msg.nodemcu_BETWEEN_AND = "and";
Blockly.Msg.nodemcu_BASE_MAP_HELPURL ="http://nodemcu.cc/en/Reference/map";
Blockly.Msg.nodemcu_BASE_MAP_NUM ="Map ";
Blockly.Msg.nodemcu_BASE_MAP_DMAX = "value to [0-";
Blockly.Msg.nodemcu_BASE_MAP_TOOLTIP = "transfer a value on a scale from 0 to 1023 to another scale";
Blockly.Msg.nodemcu_BASE_CODE = "Coding";
Blockly.Msg.nodemcu_BASE_COMMENT_HELPURL = "https://www.nodemcu.cc/reference/en/language/structure/further-syntax/blockcomment/";
Blockly.Msg.nodemcu_BASE_COMMENT_TEXT = "comment";
Blockly.Msg.nodemcu_BASE_CONST = "define";
Blockly.Msg.nodemcu_BASE_DEFINE_HELPURL = "https://www.nodemcu.cc/en/Reference/Define";
Blockly.Msg.nodemcu_BASE_DEFINE = "Define";
Blockly.Msg.nodemcu_BASE_DEFINE_TOOLTIP = "Define constants & librairies";
Blockly.Msg.nodemcu_BASE_END = 'wait forever (END of program)';
Blockly.Msg.nodemcu_BASE_BEGIN_TOOLTIP = "help to show start and end of a program";
Blockly.Msg.nodemcu_BASE_BEGIN = "START program";
Blockly.Msg.nodemcu_BASE_TEMPO1 = "when";
Blockly.Msg.nodemcu_BASE_TEMPO2 = "elapsed";
Blockly.Msg.nodemcu_BASE_TEMPO_TIME = [["microsecondes", "us"],["millisecondes", "ms"],["secondes", "s"]];
Blockly.Msg.nodemcu_BASE_TEMPO_TOOLTIP = "Verify if interval of time is elapsed, if so do instructions.";
Blockly.Msg.nodemcu_BASE_TEMPO_HELPURL = "http://www.mon-club-elec.fr/pmwiki_reference_nodemcu/pmwiki.php?n=Main.ExempleBlinkWithoutDelay";
Blockly.Msg.nodemcu_BASE_TOGGLE = "toggle PIN state";
Blockly.Msg.nodemcu_BASE_TOGGLE_TOOLTIP = "Toggle :\nwrite logic state 0 if was 1, or 1 if was 1, on PIN#";
Blockly.Msg.nodemcu_BASE_INCLUDE_FILE_TEXT = "Inclure un fichier";
Blockly.Msg.nodemcu_BASE_INCLUDE_FILE_NAME = "Nom du fichier";
Blockly.Msg.nodemcu_BASE_INCLUDE_FILE_TOOLTIP = "Permet d'inclure un fichier contenu dans le repertoire de travail";
Blockly.Msg.nodemcu_BASE_INCLUDE_FILE_HELPURL = "https://www.nodemcu.cc/reference/en/language/structure/further-syntax/include/";
Blockly.Msg.nodemcu_CONSTRAIN = "constrain";
Blockly.Msg.nodemcu_CONSTRAIN_X = " number";
Blockly.Msg.nodemcu_CONSTRAIN_A = "from A = ";
Blockly.Msg.nodemcu_CONSTRAIN_B = "to B = ";
Blockly.Msg.nodemcu_CONSTRAIN_HELPURL = 'http://nodemcu.cc/en/Reference/Constrain';
Blockly.Msg.nodemcu_CONSTRAIN_TOOLTIP = 'Constrains a number to be within a range.';
Blockly.Msg.nodemcu_INOUT_BUILDIN_LED_HELPURL = "http://nodemcu.cc/en/Reference/DigitalWrite";
Blockly.Msg.nodemcu_INOUT_BUILDIN_LED_INPUT = "put the LEDs on the card to logic";
Blockly.Msg.nodemcu_INOUT_BUILDIN_LED_TOOLTIP = "off or turn on the LED on the nodemcu board";
Blockly.Msg.nodemcu_INOUT_DIGITAL_WRITE_HELPURL = "http://nodemcu.cc/en/Reference/DigitalWrite";
Blockly.Msg.nodemcu_INOUT_DIGITAL_WRITE_INPUT1 = "NodeMCU DigitalWrite PIN#";
Blockly.Msg.nodemcu_INOUT_DIGITAL_WRITE_INPUT2 = "Stat";
Blockly.Msg.nodemcu_INOUT_DIGITAL_WRITE_TOOLTIP = "write a 0 or 1 state numeric on a specific output";
Blockly.Msg.nodemcu_INOUT_DIGITAL_READ_HELPURL = "http://nodemcu.cc/en/Reference/DigitalRead";
Blockly.Msg.nodemcu_INOUT_DIGITAL_READ_INPUT = "NodeMCU DigitalRead PIN#";
Blockly.Msg.nodemcu_INOUT_DIGITAL_READ_TOOLTIP = "reading the digital state 0 or 1 of the digital pin";
Blockly.Msg.nodemcu_INOUT_DIGITAL_READ_PULL_UP = "pull up";
Blockly.Msg.nodemcu_INOUT_DIGITAL_READ_PULL_UP_TOOLTIP = "reading the digital state 0 or 1 of the digital pin\npull-up option to check";
Blockly.Msg.nodemcu_INOUT_PWM_WRITE_HELPURL = "http://nodemcu.cc/en/Reference/AnalogWrite";
Blockly.Msg.nodemcu_INOUT_PWM_WRITE_INPUT1 = "write on pin PWM~";
Blockly.Msg.nodemcu_INOUT_PWM_WRITE_INPUT2 = "value";
Blockly.Msg.nodemcu_INOUT_PWM_WRITE_TOOLTIP = "send a value between 0 and 255 on a specific output \nWARNING verify the No. on the board !";
Blockly.Msg.nodemcu_INOUT_ANALOG_WRITE_HELPURL = "http://nodemcu.cc/en/Reference/AnalogWrite";
Blockly.Msg.nodemcu_INOUT_ANALOG_WRITE_INPUT1 = "NodeMCU AnalogWrite PIN#";
Blockly.Msg.nodemcu_INOUT_ANALOG_WRITE_INPUT2 = "value";
Blockly.Msg.nodemcu_INOUT_ANALOG_WRITE_TOOLTIP = "send a value between 0 and 255 on a specific output";
Blockly.Msg.nodemcu_TONE_HELPURL = "http://nodemcu.cc/en/Reference/AnalogWrite";
Blockly.Msg.nodemcu_TONE_INPUT1 = "emits sound on the pin";
Blockly.Msg.nodemcu_TONE_INPUT2 = "on frequency (Hz)";
Blockly.Msg.nodemcu_TONE_INPUT3 = "for a time (ms)";
Blockly.Msg.nodemcu_TONE_TOOLTIP = "emits sound on the selected pin";
Blockly.Msg.nodemcu_NOTONE_HELPURL = "http://nodemcu.cc/en/Reference/AnalogWrite";
Blockly.Msg.nodemcu_NOTONE_INPUT = "stop sound on the pin";
Blockly.Msg.nodemcu_NOTONE_TOOLTIP = "mutes the sound on the selected pin";
Blockly.Msg.nodemcu_INOUT_ANALOG_READ_HELPURL = "http://nodemcu.cc/en/Reference/AnalogRead";
Blockly.Msg.nodemcu_INOUT_ANALOG_READ_INPUT = "read value on the analog input";
Blockly.Msg.nodemcu_INOUT_ANALOG_READ_TOOLTIP = "returns a value between 0 and 1023";
Blockly.Msg.nodemcu_INOUT_ONOFF_HELPURL = "http://nodemcu.cc/en/Reference/Constants";
Blockly.Msg.nodemcu_INOUT_STATE = "state";
Blockly.Msg.nodemcu_PULSEIN="PulseIn (µs) pin#";
Blockly.Msg.nodemcu_PULSEIN_TIMEOUT="timeout (µs) ";
Blockly.Msg.nodemcu_SERVO_MOVE_HELPURL = "http://www.nodemcu.cc/playground/ComponentLib/servo";
Blockly.Msg.nodemcu_SERVO_MOVE_INPUT1 = "rotate the servo-motor";
Blockly.Msg.nodemcu_SERVO_MOVE_IMAGE = "images/a991.jpg";
Blockly.Msg.nodemcu_SERVO_MOVE_INPUT2 = "on the pin";
Blockly.Msg.nodemcu_SERVO_MOVE_DEGREE = "an angle (0~180°) of";
Blockly.Msg.nodemcu_SERVO_MOVE_DELAY_TIME = "during a period (ms)";
Blockly.Msg.nodemcu_SERVO_MOVE_TOOLTIP = "rotation possible between 0 ~ 180 degrees";
Blockly.Msg.nodemcu_SERVO_READ_DEGREES_HELPURL = "http://www.nodemcu.cc/playground/ComponentLib/servo";
Blockly.Msg.nodemcu_SERVO_READ_DEGREES_INPUT1 = "the angle of the servo motor";
Blockly.Msg.nodemcu_SERVO_READ_DEGREES_IMAGE = "images/a991.jpg";
Blockly.Msg.nodemcu_SERVO_READ_DEGREES_INPUT2 = "connected on the pin";
Blockly.Msg.nodemcu_SERVO_READ_DEGREES_TOOLTIP = "returns the number of degrees the last rotation";
Blockly.Msg.nodemcu_SERVO_ROT_CONTINUE_HELPURL = "https://www.nodemcu.cc/en/Reference/ServoWrite";
Blockly.Msg.nodemcu_SERVO_ROT_CONTINUE_TEXT = "turn continuous servomotor";
Blockly.Msg.nodemcu_SERVO_ROT_CONTINUE_INPUT1 = "PIN#";
Blockly.Msg.nodemcu_SERVO_ROT_CONTINUE_INPUT2 = "speed [0~180]";
Blockly.Msg.nodemcu_SERVO_ROT_CONTINUE_INPUT3 = "speed [0~90]";
Blockly.Msg.nodemcu_SERVO_ROT_CONTINUE_INPUT4 = "direction";
Blockly.Msg.nodemcu_SERVO_ROT_CONTINUE_TOOLTIP = "degrees for power : 0° -> max on left | 90° -> stop | 180° -> max on right";
Blockly.Msg.nodemcu_SERVO_PIN = "PIN#";
Blockly.Msg.nodemcu_SERVO_ATTACH1 = "attach servomotor";
Blockly.Msg.nodemcu_SERVO_ATTACH2 = "id#";
Blockly.Msg.nodemcu_SERVO_ATTACHED = "servo attached ?";
Blockly.Msg.nodemcu_SERVO_DETACH = "detach servo on PIN#";
Blockly.Msg.nodemcu_SERIAL_PRINT_HELPURL = "http://www.nodemcu.cc/en/Serial/Print";
Blockly.Msg.nodemcu_SERIAL_PRINT_CONTENT = "Serial Print";
Blockly.Msg.nodemcu_SERIAL_PRINTLN_CONTENT = "print new line data on serial port:";
Blockly.Msg.nodemcu_SERIAL_PRINT_TAB_CONTENT = "print with tab data on serial port:";
Blockly.Msg.nodemcu_SERIAL_PRINT_TOOLTIP = "sends data over the serial port for sruvaillance by the monitor in ASCII";
Blockly.Msg.nodemcu_SERIAL_PRINT_VAR_TEXT = "print text on serial port :";
Blockly.Msg.nodemcu_SERIAL_PRINT_VAR_NUMBER = "with this following number :";
Blockly.Msg.nodemcu_SERIAL_PRINT_VAR_NEW_LINE = "and go to a new line ?";
Blockly.Msg.nodemcu_SERIAL_PRINT_MULTI_NUMBER = "Afficher sur le port Série :";
Blockly.Msg.nodemcu_SERIAL_PRINT_MULTI_NEWLINE = "Nouvelle ligne?";
Blockly.Msg.nodemcu_SERIAL_PRINT_MULTI_FIELDDROPDOWN = [["oui", "true"], ["non", "false"]];

//MHET

Blockly.Msg.mhet_BASE_DELAY_HELPURL = "http://mhet.cc/en/Reference/delay";
Blockly.Msg.mhet_BASE_DELAY_DELAY_TIME = "delay (in ms)";
Blockly.Msg.mhet_BASE_DELAY_DELAY_TIME_SEC = "wait (in seconds)";
Blockly.Msg.mhet_BASE_DELAY_TOOLTIP = "specify the pause time in milliseconds";
Blockly.Msg.mhet_BASE_SETUP = "Setup";
Blockly.Msg.mhet_BASE_SETUP_HELPURL = "https://www.mhet.cc/en/Reference/Setup";
Blockly.Msg.mhet_BASE_LOOP = "mhet loop forever:";
Blockly.Msg.mhet_BASE_SETUP_LOOP_HELPURL = "https://www.mhet.cc/en/Reference/Loop";
Blockly.Msg.mhet_SINCE_PROGRAM_STARTED_HELPURL = "https://www.mhet.cc/en/Reference/Millis";
Blockly.Msg.mhet_SINCE_PROGRAM_STARTED = "time (in ms) since program started";
Blockly.Msg.mhet_SINCE_PROGRAM_STARTED_SEC = "time (in s) since program started";
Blockly.Msg.mhet_SINCE_PROGRAM_STARTED_TOOLTIP = "Number of milliseconds since the program started (unsigned long)";
Blockly.Msg.mhet_BETWEEN = "random number between";
Blockly.Msg.mhet_BETWEEN_AND = "and";
Blockly.Msg.mhet_BASE_MAP_HELPURL ="http://mhet.cc/en/Reference/map";
Blockly.Msg.mhet_BASE_MAP_NUM ="Map ";
Blockly.Msg.mhet_BASE_MAP_DMAX = "value to [0-";
Blockly.Msg.mhet_BASE_MAP_TOOLTIP = "transfer a value on a scale from 0 to 1023 to another scale";
Blockly.Msg.mhet_BASE_CODE = "Coding";
Blockly.Msg.mhet_BASE_COMMENT_HELPURL = "https://www.mhet.cc/reference/en/language/structure/further-syntax/blockcomment/";
Blockly.Msg.mhet_BASE_COMMENT_TEXT = "comment";
Blockly.Msg.mhet_BASE_CONST = "define";
Blockly.Msg.mhet_BASE_DEFINE_HELPURL = "https://www.mhet.cc/en/Reference/Define";
Blockly.Msg.mhet_BASE_DEFINE = "Define";
Blockly.Msg.mhet_BASE_DEFINE_TOOLTIP = "Define constants & librairies";
Blockly.Msg.mhet_BASE_END = 'wait forever (END of program)';
Blockly.Msg.mhet_BASE_BEGIN_TOOLTIP = "help to show start and end of a program";
Blockly.Msg.mhet_BASE_BEGIN = "START program";
Blockly.Msg.mhet_BASE_TEMPO1 = "when";
Blockly.Msg.mhet_BASE_TEMPO2 = "elapsed";
Blockly.Msg.mhet_BASE_TEMPO_TIME = [["microsecondes", "us"],["millisecondes", "ms"],["secondes", "s"]];
Blockly.Msg.mhet_BASE_TEMPO_TOOLTIP = "Verify if interval of time is elapsed, if so do instructions.";
Blockly.Msg.mhet_BASE_TEMPO_HELPURL = "http://www.mon-club-elec.fr/pmwiki_reference_mhet/pmwiki.php?n=Main.ExempleBlinkWithoutDelay";
Blockly.Msg.mhet_BASE_TOGGLE = "toggle PIN state";
Blockly.Msg.mhet_BASE_TOGGLE_TOOLTIP = "Toggle :\nwrite logic state 0 if was 1, or 1 if was 1, on PIN#";
Blockly.Msg.mhet_BASE_INCLUDE_FILE_TEXT = "Inclure un fichier";
Blockly.Msg.mhet_BASE_INCLUDE_FILE_NAME = "Nom du fichier";
Blockly.Msg.mhet_BASE_INCLUDE_FILE_TOOLTIP = "Permet d'inclure un fichier contenu dans le repertoire de travail";
Blockly.Msg.mhet_BASE_INCLUDE_FILE_HELPURL = "https://www.mhet.cc/reference/en/language/structure/further-syntax/include/";
Blockly.Msg.mhet_CONSTRAIN = "constrain";
Blockly.Msg.mhet_CONSTRAIN_X = " number";
Blockly.Msg.mhet_CONSTRAIN_A = "from A = ";
Blockly.Msg.mhet_CONSTRAIN_B = "to B = ";
Blockly.Msg.mhet_CONSTRAIN_HELPURL = 'http://mhet.cc/en/Reference/Constrain';
Blockly.Msg.mhet_CONSTRAIN_TOOLTIP = 'Constrains a number to be within a range.';
Blockly.Msg.mhet_INOUT_BUILDIN_LED_HELPURL = "http://mhet.cc/en/Reference/DigitalWrite";
Blockly.Msg.mhet_INOUT_BUILDIN_LED_INPUT = "put the LEDs on the card to logic";
Blockly.Msg.mhet_INOUT_BUILDIN_LED_TOOLTIP = "off or turn on the LED on the mhet board";
Blockly.Msg.mhet_INOUT_DIGITAL_WRITE_HELPURL = "http://mhet.cc/en/Reference/DigitalWrite";
Blockly.Msg.mhet_INOUT_DIGITAL_WRITE_INPUT1 = "MHET DigitalWrite PIN#";
Blockly.Msg.mhet_INOUT_DIGITAL_WRITE_INPUT2 = "Stat";
Blockly.Msg.mhet_INOUT_DIGITAL_WRITE_TOOLTIP = "write a 0 or 1 state numeric on a specific output";
Blockly.Msg.mhet_INOUT_DIGITAL_READ_HELPURL = "http://mhet.cc/en/Reference/DigitalRead";
Blockly.Msg.mhet_INOUT_DIGITAL_READ_INPUT = "MHET DigitalRead PIN#";
Blockly.Msg.mhet_INOUT_DIGITAL_READ_TOOLTIP = "reading the digital state 0 or 1 of the digital pin";
Blockly.Msg.mhet_INOUT_DIGITAL_READ_PULL_UP = "pull up";
Blockly.Msg.mhet_INOUT_DIGITAL_READ_PULL_UP_TOOLTIP = "reading the digital state 0 or 1 of the digital pin\npull-up option to check";
Blockly.Msg.mhet_INOUT_PWM_WRITE_HELPURL = "http://mhet.cc/en/Reference/AnalogWrite";
Blockly.Msg.mhet_INOUT_PWM_WRITE_INPUT1 = "write on pin PWM~";
Blockly.Msg.mhet_INOUT_PWM_WRITE_INPUT2 = "value";
Blockly.Msg.mhet_INOUT_PWM_WRITE_TOOLTIP = "send a value between 0 and 255 on a specific output \nWARNING verify the No. on the board !";
Blockly.Msg.mhet_INOUT_ANALOG_WRITE_HELPURL = "http://mhet.cc/en/Reference/AnalogWrite";
Blockly.Msg.mhet_INOUT_ANALOG_WRITE_INPUT1 = "MHET AnalogWrite PIN#";
Blockly.Msg.mhet_INOUT_ANALOG_WRITE_INPUT2 = "value";
Blockly.Msg.mhet_INOUT_ANALOG_WRITE_TOOLTIP = "send a value between 0 and 255 on a specific output";
Blockly.Msg.mhet_TONE_HELPURL = "http://mhet.cc/en/Reference/AnalogWrite";
Blockly.Msg.mhet_TONE_INPUT1 = "emits sound on the pin";
Blockly.Msg.mhet_TONE_INPUT2 = "on frequency (Hz)";
Blockly.Msg.mhet_TONE_INPUT3 = "for a time (ms)";
Blockly.Msg.mhet_TONE_TOOLTIP = "emits sound on the selected pin";
Blockly.Msg.mhet_NOTONE_HELPURL = "http://mhet.cc/en/Reference/AnalogWrite";
Blockly.Msg.mhet_NOTONE_INPUT = "stop sound on the pin";
Blockly.Msg.mhet_NOTONE_TOOLTIP = "mutes the sound on the selected pin";
Blockly.Msg.mhet_INOUT_ANALOG_READ_HELPURL = "http://mhet.cc/en/Reference/AnalogRead";
Blockly.Msg.mhet_INOUT_ANALOG_READ_INPUT = "read value on the analog input";
Blockly.Msg.mhet_INOUT_ANALOG_READ_TOOLTIP = "returns a value between 0 and 1023";
Blockly.Msg.mhet_INOUT_ONOFF_HELPURL = "http://mhet.cc/en/Reference/Constants";
Blockly.Msg.mhet_INOUT_STATE = "state";
Blockly.Msg.mhet_PULSEIN="PulseIn (µs) pin#";
Blockly.Msg.mhet_PULSEIN_TIMEOUT="timeout (µs) ";
Blockly.Msg.mhet_SERVO_MOVE_HELPURL = "http://www.mhet.cc/playground/ComponentLib/servo";
Blockly.Msg.mhet_SERVO_MOVE_INPUT1 = "rotate the servo-motor";
Blockly.Msg.mhet_SERVO_MOVE_IMAGE = "images/a991.jpg";
Blockly.Msg.mhet_SERVO_MOVE_INPUT2 = "on the pin";
Blockly.Msg.mhet_SERVO_MOVE_DEGREE = "an angle (0~180°) of";
Blockly.Msg.mhet_SERVO_MOVE_DELAY_TIME = "during a period (ms)";
Blockly.Msg.mhet_SERVO_MOVE_TOOLTIP = "rotation possible between 0 ~ 180 degrees";
Blockly.Msg.mhet_SERVO_READ_DEGREES_HELPURL = "http://www.mhet.cc/playground/ComponentLib/servo";
Blockly.Msg.mhet_SERVO_READ_DEGREES_INPUT1 = "the angle of the servo motor";
Blockly.Msg.mhet_SERVO_READ_DEGREES_IMAGE = "images/a991.jpg";
Blockly.Msg.mhet_SERVO_READ_DEGREES_INPUT2 = "connected on the pin";
Blockly.Msg.mhet_SERVO_READ_DEGREES_TOOLTIP = "returns the number of degrees the last rotation";
Blockly.Msg.mhet_SERVO_ROT_CONTINUE_HELPURL = "https://www.mhet.cc/en/Reference/ServoWrite";
Blockly.Msg.mhet_SERVO_ROT_CONTINUE_TEXT = "turn continuous servomotor";
Blockly.Msg.mhet_SERVO_ROT_CONTINUE_INPUT1 = "PIN#";
Blockly.Msg.mhet_SERVO_ROT_CONTINUE_INPUT2 = "speed [0~180]";
Blockly.Msg.mhet_SERVO_ROT_CONTINUE_INPUT3 = "speed [0~90]";
Blockly.Msg.mhet_SERVO_ROT_CONTINUE_INPUT4 = "direction";
Blockly.Msg.mhet_SERVO_ROT_CONTINUE_TOOLTIP = "degrees for power : 0° -> max on left | 90° -> stop | 180° -> max on right";
Blockly.Msg.mhet_SERVO_PIN = "PIN#";
Blockly.Msg.mhet_SERVO_ATTACH1 = "attach servomotor";
Blockly.Msg.mhet_SERVO_ATTACH2 = "id#";
Blockly.Msg.mhet_SERVO_ATTACHED = "servo attached ?";
Blockly.Msg.mhet_SERVO_DETACH = "detach servo on PIN#";
Blockly.Msg.mhet_SERIAL_PRINT_HELPURL = "http://www.mhet.cc/en/Serial/Print";
Blockly.Msg.mhet_SERIAL_PRINT_CONTENT = "Serial Print";
Blockly.Msg.mhet_SERIAL_PRINTLN_CONTENT = "print new line data on serial port:";
Blockly.Msg.mhet_SERIAL_PRINT_TAB_CONTENT = "print with tab data on serial port:";
Blockly.Msg.mhet_SERIAL_PRINT_TOOLTIP = "sends data over the serial port for sruvaillance by the monitor in ASCII";
Blockly.Msg.mhet_SERIAL_PRINT_VAR_TEXT = "print text on serial port :";
Blockly.Msg.mhet_SERIAL_PRINT_VAR_NUMBER = "with this following number :";
Blockly.Msg.mhet_SERIAL_PRINT_VAR_NEW_LINE = "and go to a new line ?";
Blockly.Msg.mhet_SERIAL_PRINT_MULTI_NUMBER = "Afficher sur le port Série :";
Blockly.Msg.mhet_SERIAL_PRINT_MULTI_NEWLINE = "Nouvelle ligne?";
Blockly.Msg.mhet_SERIAL_PRINT_MULTI_FIELDDROPDOWN = [["oui", "true"], ["non", "false"]];
...
////////////////////////////ESP8266 WiFi/////////////////////
Blockly.Msg.esp8266_init_tooltip="Initialize Wifi ESP8266 Module";
Blockly.Msg.esp8266_1="ESP8266";
Blockly.Msg.esp8266_2="ssid";
Blockly.Msg.esp8266_3="key"; //"clé";
Blockly.Msg.esp8266_4="IP";
Blockly.Msg.esp8266_5="bridge"; //"passerelle";
...
Blockly.Msg.esp8266_10="addressing"; //"adressage";
...
////////////////////////////esp32 WiFi/////////////////////
Blockly.Msg.esp32_init_tooltip="Initialize Wifi ESP32 Module";
Blockly.Msg.esp32_1="ESP32";
Blockly.Msg.esp32_2="ssid";
Blockly.Msg.esp32_3="key"; //"clé";
Blockly.Msg.esp32_4="IP";
Blockly.Msg.esp32_5="bridge"; //"passerelle";
Blockly.Msg.esp32_6="masque";
Blockly.Msg.esp32_7=[["client", "client"],["server", "server"]];
Blockly.Msg.esp32_8="port";
Blockly.Msg.esp32_9=[["dynamic", "dynamic"],["static", "static"]];
Blockly.Msg.esp32_10="addressing"; //"adressage";
Blockly.Msg.esp32_recept_tooltip="reception";
Blockly.Msg.esp32_url="";
Blockly.Msg.esp32_send_html_tooltip="...";
Blockly.Msg.esp32_send_html="";
Blockly.Msg.esp32_send_tooltip="...";
Blockly.Msg.esp32_send="";
Blockly.Msg.esp32_wait_tooltip="...";
