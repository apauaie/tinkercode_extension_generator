...
This library has been merged with QTRSensors and jebat motor Library.
...
//Init extra pin
const int irR = 5;//need to double check
const int irL = 26;
const int Relay = 5;
...
class QTRSensors
{
  public:
    ...
    void jebatbotFinderW(int inByte, int inNext, int lajur, int lajul, float turn, int speedturn, float kp, float kd, int sensorc, int lajak, int dturn);
    void jebatbotFinderB(int inByte, int inNext, int lajur, int lajul, float turn, int speedturn, float kp, float kd, int sensorc, int lajak, int dturn);
	void jebatbotDtracer(int lajur, int lajul, int speedturn, float kp, float kd, int sensorc, int linef, int dtracer); 
	void jebatbotflineB(int lajur, int lajul, int sensorc, int linef); 
	void jebatbotflineW(int lajur, int lajul, int sensorc, int linef); 
	void jebatbottillJunction(int lajul, int lajur, int speedturn, int sensorc, int inByte, float kp, float kd,int linef,int basespeed,int forwarddelay);
    void jebatbottillJunctionSimple(int laju,  int inByte, float kp, float kd, int linef);
    void jebatbotFinderBlack(int inByte, int inNext, int laju, int turnspeed,float kp, float kd , int lajak,int turndelay); // (type of junction, next robot action, robot speed, turn speed percentage)
	void jebatbotFinderWhite(int inByte, int inNext, int laju, int turnspeed,float kp, float kd, int terus,int turndelay); // (type of junction, next robot action, robot speed, turn speed percentage)
...
class jebatbot : public QTRSensors
{
  public:
    ...
    void megablink(int,int,int,int);
    void knightrider(int,int,int,int);
    void setPixyColor(int,int);
    void brightnessPixyColor(int);
    void clearPixyColor();
    void MazeRunner(int);
